...
input_sender = st.text_input("Who is the sender in the transaction?")


# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_receiver = st.text_input("Who is the recevier in the transaction?")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_amount = st.text_input("What is the amount of the transfer?")
